...
function About() {
  ...
  return (
    <section className="flex items-center justify-center h-fit text-left">
      <div className="flex flex-col items-center justify-center w-11/12  sm:w-9/12 rounded-xl bg-background text-foreground">
        <h1 className="text-3xl">{t("about.label")} </h1>
        <article className="">
